...
const AccountController = {
    ...
    * @param res - The response object from express server ( unused )
    * 
    * @return { Object } The updated account in response to Express HTTP request ( used for validation and database operations
    */
    ...
    * @param res - The response object from express server ( unused )
    * 
    * @return { Object } The message responsed to Express HTTP request ( used for validation and database operations
    */
