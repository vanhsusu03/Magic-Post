            ...
            <ul class="mt-4">
                <li class="relative px-6 py-3">
                    ...
                    <a @click="display(0)" v-if="selecteds"
                        ...
                        <svg class="w-8 h-8" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round"
                ...
                <li v-if="leadership" class="relative px-6 py-3">
                    ...
                    <a @click="display(3)"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#858585"
                            class="w-8 h-8" version="1.1" id="Capa_1" viewBox="0 0 489.475 489.475" xml:space="preserve"
                            stroke="#858585">
                ...
                <li class="relative px-6 py-3">
                    ...
                    <a @click="display(5)"
                        class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" viewBox="0 0 48 48" fill="none" stroke="">
...
export default {
    ...
    methods: {
        ...
        sidebarToggle() {
            ...
            this.$emit('childEvent', this.isExpand);
        }
    },
    computed: {
