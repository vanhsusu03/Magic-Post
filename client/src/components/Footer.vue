    ...
    <div class="bg-cyan-700 px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-full md:px-24 lg:px-8">
        <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="space-y-2 text-sm">
                ...
                <div class="flex">
                    <p class="mr-1 text-slate-100">Phone: +84355 110 113</p>
                </div>
                <div class="flex">
                    <p class="mr-1 text-slate-100">Email: nta2305003@gmail.com</p>
                </div>
                <div class="flex">
                    <p class="mr-1 text-slate-100">Address: 144 Xuân Thủy, Cầu Giấy</p>
                </div>
            </div>
            <div>
                <span class="text-base font-bold tracking-wide text-slate-100">Social</span>
                <div class="flex items-center mt-1 space-x-3">
                    <a href="/" class="text-slate-100 transition-colors duration-300 hover:text-deep-purple-accent-400">
